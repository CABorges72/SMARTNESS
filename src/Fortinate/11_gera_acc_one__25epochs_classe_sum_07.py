...
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/dicionarios/dict_opcodes_one_sum_07.dic.gz")
...
#  final = 450130+(cont*130)
  ...
  #inicio = 130000+(cont*50)
  #final  = 130050+(cont*50)

  #inicio = 340000+(cont*6)
  #final  = 3400306+(cont*6)
...
#  codeSequence_teste = codeSequence[(tamanho+(cont*15)):450015+(cont*15)]
  ...
  #Teste da classe 7 com modelo 1
  eval = model01.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 2
  eval = model02.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 3
  eval = model03.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 4
  eval = model04.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 5
  eval = model05.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 6
  eval = model06.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 7 com modelo 7
