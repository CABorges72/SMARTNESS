...
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/dicionarios/dict_opcodes_one_sum_03.dic.gz")
...
"""# Ler base de teste classe 03"""

label=4 # modelo que será gerado
dd=3
look_back = 5
#look_back = 90
...
#  final = 450300+(cont*300)
  ...
  #inicio = 80000+(cont*30)
  #final  = 80030+(cont*30)

  #inicio = 80000+(cont*300)
  #final  = 80300+(cont*300)

  #inicio = 143000+(cont*360)
  #final  = 143360+(cont*360)

  #inicio = 440000+(cont*360)
  #final  = 440360+(cont*360)

  #inicio = 600000+(cont*300)
  #final  = 600300+(cont*300)

#  inicio = 1200000+(cont*300)
#  final  = 1200300+(cont*300)

#  inicio = 1200000+(cont*360)
#  final  = 1200360+(cont*360)
...
#  inicio = 130000+(cont*360)
#  final  = 130360+(cont*360)

  #inicio = 130000+(cont)
  #final  = inicio+360

  inicio = 130000+(cont*390)
  final  = 130390+(cont*390)


#  inicio = 600000+(cont*6)
#  final  = 600006+(cont*6)
...
#  codeSequence_teste = codeSequence[(tamanho+(cont*15)):450015+(cont*15)]
  ...
  #Teste da classe 3 com modelo 1
  eval = model01.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 2
  eval = model02.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 3
  eval = model03.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 4
  eval = model04.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 5
  eval = model05.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 6
  eval = model06.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 3 com modelo 7
