...
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/dicionarios/dict_opcodes_one_sum_04.dic.gz")
...
codeSequence_teste = codeSequence[(tamanho):154000]
...
5#plt.plot(range(1,25), history.history['val_loss'], marker='+')
...
# 154000 ---> 0.6580207216863165

# 165000 ---> 0.6768922974324775

# 154000 ---> 0.7103251161128975

# 143000 ---> 0.672566371681416

# 132000 ---> 0.6431846602751147

# 176000 --->

# 88000 --->   0.5886178861788618
...
label=4
model = load_model("/content/drive/MyDrive/maldrive/WGRS-2024/modelo100/model_LSTM_" + str(label) +"_"+str(11)+ ".h5") # ler modelo de cada epoch
model.summary()

"""#Teste do modelo 4 como classe 1"""
...
"""#Teste do modelo 4 como classe 2"""
...
"""#Teste do modelo 4 como classe 3"""
...
"""#Teste do modelo 4 como classe 5"""
...
"""#Teste do modelo 4 como classe 6"""
...
"""#Teste do modelo 4 como classe 7"""
