...
#vetor = np.load("/content/drive/MyDrive/maldrive/vetorone00.npy") # dim 100
vetor = np.load("/content/drive/MyDrive/maldrive/WGRS-2024/vetorone00.npy") # dim 100
#vetor = np.load("vetorone00.npy") # dim 100
#dim=128
dim=64
#dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/dict_opcodes_rva_capstone.dic.gz")
#dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/dict_opcodes_one_sum_00.dic.gz")
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/dicionarios/dict_opcodes_one_sum_01.dic.gz")
...
dir_load="/content/drive/MyDrive/maldrive/WGRS-2024/modelo100" # windows
caminho="modelos100/"
...
#plt.plot(range(1,26), history['loss'], marker='o')
#plt.plot(range(1,26), history['acc'], marker='+')
#plt.show()

#plt.plot(range(1,26), history['loss'], marker='o', color='red')

#plt.plot(range(1,26), history['acc'], marker='+', color='blue')
...
predicts = model.predict(a, batch_size=100)
...
label = 1
graph = []
model.save("/content/drive/MyDrive/maldrive/WGRS-2024/modelo100/model_LSTM_" + str(label) +"_"+str(ep)+ ".h5") # ler modelo de cada epoch
#graph.append(history.history["loss"][0])
graph.append(history.history)
np.save("/content/drive/MyDrive/maldrive/WGRS-2024/modelo100/graph"+str(label)+".npy",np.array(graph))

ep=25
label=1
model = load_model("/content/drive/MyDrive/maldrive/WGRS-2024/modelo100/model_LSTM_" + str(label) +"_"+str(ep)+ ".h5") # ler modelo de cada epoch
model.summary()



"""#Teste do modelo 1 como classe 2"""
...
"""#Teste do modelo 1 como classe 3"""
...
"""#Teste do modelo 1 como classe 4"""
...
"""#Teste do modelo 1 como classe 5"""
...
"""#Teste do modelo 1 como classe 6"""
...
"""#Teste do modelo 1 como classe 7"""
