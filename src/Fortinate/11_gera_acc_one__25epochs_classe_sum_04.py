...
"""# Ler base de teste classe 04"""

label=5 # modelo que será gerado
dd=3
look_back = 5
#look_back = 90
...
#  final = 450130+(cont*130)
  ...
  #inicio = 130000+(cont*30)
  #final  = 130030+(cont*30)

  #inicio = 450000+(cont*6)
  #final  = 450006+(cont*6)



#  inicio = 154000+(cont*30)
#  final  = 154030+(cont*30)


#  inicio = 140000+(cont*300)
#  final  = 140300+(cont*300)

#  inicio = 140000+(cont*360)
#  final  = 140360+(cont*360)


  #inicio = 140000+(cont)
  #final  = inicio+360

  inicio = 140000+(cont*390)
  final  = 140390+(cont*390)
...
#  final  = 360+(cont*360)
  ...
  #inicio = 140000+(cont*20)
  #final  = 140020+(cont*20)
...
#  codeSequence_teste = codeSequence[(tamanho+(cont*15)):450015+(cont*15)]
  ...
  #Teste da classe 4 com modelo 1
  eval = model01.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 2
  eval = model02.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 3
  eval = model03.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 4
  eval = model04.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 5
  eval = model05.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 6
  eval = model06.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 4 com modelo 7
