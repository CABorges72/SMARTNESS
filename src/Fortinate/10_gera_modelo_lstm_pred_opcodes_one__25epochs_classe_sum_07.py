...
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/sumarios/dicionarios/dict_opcodes_one_sum_07.dic.gz")
...
label=8 # modelo que será gerado
dd=3
look_back = 5
#look_back = 90
...
# One 64 ---> 0.8146341463414634

# 132000 ---> 0.7592330137557316

# 99000 ---> 0.8450250138966092

# 176000 --->

# 88000 --->   0.8557848655409631
...
label=7
model = load_model("/content/drive/MyDrive/maldrive/WGRS-2024/modelo100/model_LSTM_" + str(label) +"_"+str(25)+ ".h5") # ler modelo de cada epoch
model.summary()

"""#Teste do modelo 7 como classe 1"""

cla = 1
#look_back = 5
#dim = 128
#file = '/content/drive/MyDrive/maldrive/arq_todos_opcodes_classe_03_completo.txt'
file = '/content/drive/MyDrive/WGRS-2024/sumarios/arq_todos_opcodes_classe_01_sumario.txt'
file_path = file.strip('\n')
lista_opcodes = load_opcodes_classe_txt_token(file_path)
...
"""#Teste do modelo 7 como classe 2"""
...
"""#Teste do modelo 7 como classe 3"""
...
"""#Teste do modelo 7 como classe 4"""
...
"""#Teste do modelo 7 como classe 5"""
...
"""#Teste do modelo 7 como classe 6"""
