...
dict_all=load_dict_from_file_gz("/content/drive/MyDrive/maldrive/WGRS-2024/dicionarios/dict_opcodes_one_sum_06.dic.gz")
...
#  final = 450130+(cont*130)
  ...
  #inicio = 130000+(cont*100)
  #final  = 130100+(cont*100)

  #inicio = 374000+(cont*300)
  #final  = 374300+(cont*300)

#  inicio = 340000+(cont*300)
#  final  = 340300+(cont*300)

#  inicio = 340000+(cont*360)
#  final  = 340360+(cont*360)
...
#  final  = inicio+360
  ...
  inicio = 340000+(cont*390)
  final  = 340390+(cont*390)
...
#  codeSequence_teste = codeSequence[(tamanho+(cont*15)):450015+(cont*15)]
  ...
  #Teste da classe 6 com modelo 1
  eval = model01.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 2
  eval = model02.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 3
  eval = model03.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 4
  eval = model04.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 5
  eval = model05.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 6
  eval = model06.evaluate(x=a, y=b)
  acur.append(eval[1])

  #Teste da classe 6 com modelo 7
